...
const generateResources = async (
    ...
    while ((step = generator.next()) && !step.done) {
      ...
      if (resources.length % 2000 === 0) {
        mask.text = `Generated ${resources.length * eventCount} of ${
          resourceCount * eventCount
        } records`;
    ...
    console.log("resourceTimeRange : ", resourceTimeRanges);
  ...
  toggleCustom = (show) => {
    scheduler.widgetMap.rangesButton.hidden =
      scheduler.widgetMap.dependenciesButton.hidden =
      resourceCountField.hidden =
      eventCountField.hidden =
        !show;
  },
  ...
  scheduler = new Scheduler({
    ...
    tbar: [
      ...
      },
      {
        ...
        label: "Events",
        tooltip:
          "Enter number of events per resource to generate and press [ENTER]",
        min: 1,
        max: 100,
        width: "auto",
        inputWidth: "4em",
