import * as Module from "https://bryntum.com/products/gantt/build/gantt.module.js";
...
const gantt = new Gantt({
  ...
  project: {
    loadUrl:
      "https://bryntum.com/products/gantt/docs/data/Gantt/examples/guides/tutorial/data.json",
    autoLoad: true,
    listeners: {
